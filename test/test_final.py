    ...
    assert str(segment) == str(
        Segment(
            [
                ...
                Drift(length=0.09, name="ARLIMSOG1A"),
                Drift(length=0.09, name="ARLIMSOG1B"),
                Drift(length=0.17, name="Drift_ARLIMSOG1p"),
                HorizontalCorrector(length=0.00, angle=0.0, name="ARLIMCXG1A"),
                VerticalCorrector(length=0.00, angle=0.0, name="ARLIMCXG1B"),
                ...
                HorizontalCorrector(length=0.00, angle=0.0, name="ARLIMCXG2A"),
                VerticalCorrector(length=0.00, angle=0.0, name="ARLIMCXG2B"),
                ...
                HorizontalCorrector(length=0.00, angle=0.0, name="ARLIMCXG3A"),
                VerticalCorrector(length=0.00, angle=0.0, name="ARLIMCXG3B"),
