...
def time_ocelot():
    ...
    for _ in range(n):
        ...
        particles = oc.generate_parray(
            nparticles=int(1e5), sigma_x=175e-6, sigma_y=175e-6
        )
...
def time_joss():
    ...
    for _ in range(n):
        ...
        particles = joss.Beam.make_random(n=int(1e5), sigma_x=175e-6, sigma_y=175e-6)
...
def time_cheetah_cpu():
    ...
    for _ in range(n):
        ...
        particles = cheetah.Beam.make_random(
            n=int(1e5), sigma_x=175e-6, sigma_y=175e-6, device="cpu"
        )
...
def time_cheetah_gpu():
    ...
    for _ in range(n):
        ...
        particles = cheetah.Beam.make_random(
            n=int(1e5), sigma_x=175e-6, sigma_y=175e-6, device="cuda"
        )
...
print(
    f"Cheetah (GPU)   |   {tcg:11.4f} s"
    if tcg is not None
    else "Cheetah (GPU)   |             N/A"
)
...
print(
    f"Cheetah (GPU)   |   {tcg_scr:11.4f} s"
    if tcg_scr is not None
    else "Cheetah (GPU)   |             N/A"
)
