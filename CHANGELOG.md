...
- Implement a more robust RPN parser, fixing a bug where short strings in an Elegant variable definition would cause parsing to fail. (see #387, #417, #413) (@amylizzle, @Hespe, @jank324)
