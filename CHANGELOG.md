...
- Allow second order tracking for dipole, drift, and quadrupole elements, and add a convenient method to set tracking method for all the segment. (see #476) (@cr-xu)
