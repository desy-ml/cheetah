...
- Included dispersion correction into the Twiss and emittance calculation in `Beam`, add dispersion terms in the `from_twiss` and `from_parameter` beam initialization methods (see #540) (@cr-xu)
