...
- Support conversion of Bmad superimposed elements into Cheetah `Superimposed` elements, and serialise nested/superimposed elements in Lattice JSON. (see #665) (@roussel-ryan, @jank324)
