...
def test_invalid_infix_expression():
    """
    Test that an invalid infix expression is correctly recognised
    as invalid and throws a `SyntaxError`.
    """
    expression = "2 +"
...
def test_nested_infix_expression():
    """
    Test that a valid infix expression with nesting is correctly
    evaluated without throwing an exception.
    """
...
def test_infix_expression_with_context():
    """
    Test that a valid infix expression with context is correctly
    evaluated without throwing an exception.
    """
    expression = "a + b"
    context = {"a": 10, "b": 5}
...
def test_infix_expression_with_invalid_context():
    """
    Test that an infix expression with an invalid context variable
...
def test_infix_expression_with_invalid_token():
    """
    Test that an infix expression with an invalid token raises
    a `SyntaxError`.
    """
...
def test_infix_expression_with_mismatched_parentheses():
    """
    Test that an infix expression with mismatched parentheses
    raises a `SyntaxError`.
    """
    expression = "(2 + 3"
...
def test_infix_expression_with_function_call():
    """
    Test that an infix expression with a function call is
    correctly evaluated.
    """
...
def test_infix_expression_with_var_conflict():
    """
    Test that an infix expression with a variable name that
    conflicts with a function name is correctly evaluated.
    """
