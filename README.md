...
<img src="https://github.com/desy-ml/cheetah/raw/master/images/hoou.png" alt="Argonne National Laboratory" style="width: 7em;" vspace="2em"/>&nbsp;&nbsp;
...
In addition, we acknowledge support from DESY (Hamburg, Germany) and KIT (Karlsruhe, Germany), members of the Helmholtz Association HGF as well as from the Science and Technology Facilities Council (UK) and the Hamburg Open Online University (HOOU).
